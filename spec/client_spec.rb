...
describe(Client) do
  describe("#name") do
    it("returns a name") do
      test_client = Client.new({:name => "Jerry"})
  ...
  describe("#id") do
    it("sets its ID when you save it") do
      client = Client.new({:name => "Jerry", :id => nil})
      client.save()
  ...
  describe("#==") do
    it "is the same client if it has the same name" do
      client1 = Client.new({:name => "Jerry", :id => 1})
      client2 = Client.new({:name => "Jerry", :id => 2})
  ...
  describe(".find") do
    it "returns a client by its ID" do
      test_client = Client.new({:name => "Jerry", :id => nil})
      test_client.save()
      test_client2 = Client.new({:name => "Elaine", :id => nil})
      test_client2.save()
  ...
  describe("#delete") do
    it "lets you delete a client from the database" do
      client = Client.new({:name => "Jerry", :id => nil})
      client.save()
      client2 = Client.new({:name => "Elaine", :id => nil})
      client2.save()
      client.delete()
